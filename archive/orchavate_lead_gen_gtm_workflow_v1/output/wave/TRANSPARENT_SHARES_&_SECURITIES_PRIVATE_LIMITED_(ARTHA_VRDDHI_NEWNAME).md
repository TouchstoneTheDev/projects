# WAVE Manual Spot-Check: TRANSPARENT SHARES & SECURITIES PRIVATE LIMITED (ARTHA VRDDHI NEWNAME)
Website: http://www.w3.org/TR/html4/loose.dtd

Steps:
1. Install the WAVE browser extension (Chrome/Firefox).
2. Open the site: http://www.w3.org/TR/html4/loose.dtd
