...
async function loadPublicProfile(username) {
  ...
  try {
    ...
    // Built-in Demo Profile Handler (Always accessible)
    if (username === 'demo') {
      userData = {
        username: 'demo',
        displayName: 'Dr. Alex Rivers',
        tagline: 'Clinical Psychologist & Wellness Consultant',
        bio: 'Helping individuals cultivate mental clarity, resilience, and personal growth. Specialized in cognitive behavioral therapy and mindfulness.',
        ...
        links: [
          ...
          { id: '4', title: 'Follow on Twitter / X', url: 'https://twitter.com', badge: '', active: true },
          { id: '5', title: 'Professional LinkedIn Profile', url: 'https://linkedin.com', badge: '', active: true }
        ]
      };
