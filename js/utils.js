...
export function applyTheme(themeName = 'midnight', targetElement = document.body) {
  const themes = [
    'theme-midnight', 'theme-sunset', 'theme-neon', 'theme-forest', 'theme-minimal',
    'theme-doctor', 'theme-engineer', 'theme-psychologist', 'theme-lawyer', 'theme-artist', 'theme-finance'
  ];
