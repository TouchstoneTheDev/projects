# Accessibility & GTM Outreach Audit Report — Lupin Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `96 / 100`  
> **Total WCAG Violations:** `1`  
> **Verified Contact Email:** `info@lupin.com`  
...
- **Primary Outreach Contact:** `info@lupin.com` (`Verified`)
...
- **Resolved URL:** [https://www.lupin.com](https://www.lupin.com)
...
- **Primary Contact Email:** `info@lupin.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `info@lupin.com` | **Status:** `Verified` | **Source Page:** https://www.lupin.com
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Lupin_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Lupin_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Lupin_Limited_Homepage_Lighthouse_Summary.png`
