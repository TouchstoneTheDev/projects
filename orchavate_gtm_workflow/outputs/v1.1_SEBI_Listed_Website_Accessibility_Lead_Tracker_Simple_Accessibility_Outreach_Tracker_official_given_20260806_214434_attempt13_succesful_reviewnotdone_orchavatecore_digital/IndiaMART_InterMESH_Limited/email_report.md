...
2. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `#qaPostRequirement > .hero-action-label`
3. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.hero-action-b > .hero-action-label`
4. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.hero-action-c > .hero-action-label`
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.gap-6 > .footerpremium-link.hover\:text-white.no-underline:nth-child(1)`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.footerpremium-link.hover\:text-white.no-underline:nth-child(2)`
