...
> **Verified Contact Email:** `abc@gmail.com`  
...
- **Primary Outreach Contact:** `abc@gmail.com` (`Verified`)
...
- **Primary Contact Email:** `abc@gmail.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `abc@gmail.com` | **Status:** `Verified` | **Source Page:** https://www.adityabirlacapital.com
