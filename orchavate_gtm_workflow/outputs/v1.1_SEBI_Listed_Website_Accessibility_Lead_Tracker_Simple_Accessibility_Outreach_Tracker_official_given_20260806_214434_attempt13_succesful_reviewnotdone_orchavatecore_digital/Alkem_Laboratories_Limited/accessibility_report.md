...
- **Impact Breakdown:** Critical: `1` | Serious: `34` | Moderate: `0`

### Technical Violation Breakdown
- 🖼️ **Missing Alt Text:** 0 violations
- 🎨 **Color Contrast Failures:** 11 violations
- 📝 **Form & Structural Labels:** 0 violations
- ⌨️ **Keyboard Navigation & Focus:** 20 violations
...
- **Keyboard & Focus Management (20 issues):** Ensure all interactive buttons/links are focusable via `Tab` key and visual focus outlines are visible.
...
1. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   ...
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="-3"]`
2. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="-2"]`
3. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="-1"]`
4. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-slide[data-index="3"][aria-hidden="true"]`
5. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="4"]`
6. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="5"]`
7. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="6"]`
8. **`[keyboard_navigation] aria-hidden-focus`** (SERIOUS)
   - **Help:** ARIA hidden element must not be focusable or contain focusable elements
   - **Selector:** `.offerings-wrapper > .slick-list > .slick-track > .slick-cloned.slick-slide[data-index="7"]`
