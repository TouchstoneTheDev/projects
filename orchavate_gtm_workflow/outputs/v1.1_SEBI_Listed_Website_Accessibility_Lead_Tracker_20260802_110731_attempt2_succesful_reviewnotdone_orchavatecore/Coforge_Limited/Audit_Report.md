...
- **Impact Breakdown:** Critical: `18` | Serious: `10` | Moderate: `0`
...
- **Resolved URL:** [https://www.coforge.com](https://www.coforge.com)
...
3. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.ch2-allow-all-btn`
4. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.ch2-deny-all-btn`
