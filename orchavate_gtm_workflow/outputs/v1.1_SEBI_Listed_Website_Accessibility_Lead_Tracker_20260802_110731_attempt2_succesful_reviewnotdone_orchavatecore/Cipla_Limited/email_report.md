...
- **Impact Breakdown:** Critical: `11` | Serious: `14` | Moderate: `0`
...
1. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.menu-item-has-children:nth-child(1) > a[href$="about-us"]`
2. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(2) > a[href="/"]`
3. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(3) > a[href$="our-offerings"]`
4. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(4) > a[href$="investors"]`
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(5) > a[href$="sustainability"]`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(6) > a[href$="careers"]`
7. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `li:nth-child(7) > a[href$="media-releases"]`
8. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `li:nth-child(8) > a[href$="contact-us"]`
9. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.menu-item-has-children:nth-child(9) > a[href$="cipla-foundation"]`
