...
- **Impact Breakdown:** Critical: `6` | Serious: `29` | Moderate: `0`
...
5. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `#\31 20746 > .limit-width.row-parent[data-imgready="true"] > .wpb_row.row-inner > .col-lg-3.column_parent.wpb_column > .uncol.style-light > .uncoltable > .no-block-padding.uncell.boomapps_vccolumn > .uncont > .uncode_text_column > p`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#\31 04678 > .limit-width.row-parent[data-imgready="true"] > .wpb_row.row-inner > .col-lg-3.column_parent.wpb_column > .uncol.style-light > .uncoltable > .no-block-padding.uncell.boomapps_vccolumn > .uncont > .uncode_text_column > p`
