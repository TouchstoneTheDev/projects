# Accessibility & GTM Outreach Audit Report — GOCL Corporation Ltd
...
- **Impact Breakdown:** Critical: `15` | Serious: `14` | Moderate: `0`
...
- **Company Name:** GOCL Corporation Ltd
...
8. **`[missing_alt_text] image-alt`** (CRITICAL)
   - **Help:** Images must have alternative text
   - **Selector:** `div[aria-label="3 / 15"] > .hp-ugc-video > video > img`
9. **`[missing_alt_text] image-alt`** (CRITICAL)
   - **Help:** Images must have alternative text
   - **Selector:** `div[aria-label="4 / 15"] > .hp-ugc-video > video > img`
10. **`[missing_alt_text] image-alt`** (CRITICAL)
   - **Help:** Images must have alternative text
   - **Selector:** `div[aria-label="5 / 15"] > .hp-ugc-video > video > img`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/GOCL_Corporation_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/GOCL_Corporation_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/GOCL_Corporation_Ltd_Homepage_Lighthouse_Summary.png`
