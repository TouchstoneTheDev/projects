# Accessibility & GTM Outreach Audit Report — Gandhi Special Tubes Ltd
...
- **Impact Breakdown:** Critical: `2` | Serious: `18` | Moderate: `0`
...
- **Company Name:** Gandhi Special Tubes Ltd
...
8. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `iframe[marginheight="0"] > .iBIUR`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Gandhi_Special_Tubes_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Gandhi_Special_Tubes_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Gandhi_Special_Tubes_Ltd_Homepage_Lighthouse_Summary.png`
