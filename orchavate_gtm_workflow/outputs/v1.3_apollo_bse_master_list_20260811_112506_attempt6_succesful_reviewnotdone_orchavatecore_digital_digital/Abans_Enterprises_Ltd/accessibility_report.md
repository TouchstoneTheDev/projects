# Accessibility & GTM Outreach Audit Report — Abans Enterprises Ltd
...
- **Company Name:** Abans Enterprises Ltd
...
1. **`[other] aria-allowed-attr`** (CRITICAL)
   ...
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-wps-c60=""]:nth-child(1) > a[_ngcontent-wps-c60=""]`
2. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-wps-c60=""]:nth-child(2) > a[_ngcontent-wps-c60=""]`
3. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-wps-c60=""]:nth-child(3) > a[_ngcontent-wps-c60=""]`
4. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-wps-c60=""]:nth-child(4) > a[_ngcontent-wps-c60=""]`
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `dt:nth-child(2)`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.info[_ngcontent-wps-c71=""] > strong`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Abans_Enterprises_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Abans_Enterprises_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Abans_Enterprises_Ltd_Homepage_Lighthouse_Summary.png`
