# Accessibility & GTM Outreach Audit Report — EID Parry India Limited
...
- **Impact Breakdown:** Critical: `17` | Serious: `27` | Moderate: `0`
...
- **Company Name:** EID Parry India Limited
...
3. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.owl-item:nth-child(1) > .item > .row > .col-sm-8 > h3 > a`
4. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.owl-item:nth-child(1) > .item > .row > .col-sm-8 > .read-more-1 > a`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/EID_Parry_India_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/EID_Parry_India_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/EID_Parry_India_Limited_Homepage_Lighthouse_Summary.png`
