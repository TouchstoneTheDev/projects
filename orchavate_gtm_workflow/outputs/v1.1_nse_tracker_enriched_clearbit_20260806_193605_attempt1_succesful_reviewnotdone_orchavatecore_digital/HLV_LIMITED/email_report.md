# Accessibility & GTM Outreach Audit Report — HLV LIMITED

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `30 / 100`  
> **Total WCAG Violations:** `111`  
...
This company currently scores **30/100** on automated WCAG 2.1 AA accessibility testing with **111 identified WCAG violations**. 
...
- **Impact Breakdown:** Critical: `73` | Serious: `38` | Moderate: `0`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/HLV_LIMITED_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/HLV_LIMITED_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/HLV_LIMITED_Homepage_Lighthouse_Summary.png`
