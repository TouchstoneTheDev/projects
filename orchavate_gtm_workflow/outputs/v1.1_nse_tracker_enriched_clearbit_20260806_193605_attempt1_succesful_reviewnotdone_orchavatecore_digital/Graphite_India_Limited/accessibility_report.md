# Accessibility & GTM Outreach Audit Report — Graphite India Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `96 / 100`  
> **Total WCAG Violations:** `1`  
> **Verified Contact Email:** `white@2x.webp`  
...
- **Primary Outreach Contact:** `white@2x.webp` (`Verified`)
...
- **Resolved URL:** [https://graphite.com](https://graphite.com)
...
- **Primary Contact Email:** `white@2x.webp` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `white@2x.webp` | **Status:** `Verified` | **Source Page:** https://graphite.com
...
1. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.sm\:text-xs > .flex:nth-child(2)`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Graphite_India_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Graphite_India_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Graphite_India_Limited_Homepage_Lighthouse_Summary.png`
