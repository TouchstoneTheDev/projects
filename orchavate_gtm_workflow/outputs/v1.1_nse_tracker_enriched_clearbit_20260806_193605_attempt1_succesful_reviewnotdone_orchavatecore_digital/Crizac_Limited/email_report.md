# Accessibility & GTM Outreach Audit Report — Crizac Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `info@crizac.com`  
...
- **Primary Outreach Contact:** `info@crizac.com` (`Verified`)
...
- **Resolved URL:** [https://crizacglobal.com](https://crizacglobal.com)
...
- **Primary Contact Email:** `info@crizac.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **Investor Grievance / Compliance Officer Email:** `info@crizac.com` | **Status:** `Verified` | **Source Page:** https://crizacglobal.com
- **General Contact Email:** `info@crizac.com` | **Status:** `Verified` | **Source Page:** https://crizacglobal.com
...
2. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.banner-txt-inner > .btn-primary`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Crizac_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Crizac_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Crizac_Limited_Homepage_Lighthouse_Summary.png`
