# Accessibility & GTM Outreach Audit Report — Black Box Limited
...
- **Impact Breakdown:** Critical: `4` | Serious: `21` | Moderate: `0`
...
- **Company Name:** Black Box Limited
...
3. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `#elementor-popup-modal-4328`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Black_Box_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Black_Box_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Black_Box_Limited_Homepage_Lighthouse_Summary.png`
