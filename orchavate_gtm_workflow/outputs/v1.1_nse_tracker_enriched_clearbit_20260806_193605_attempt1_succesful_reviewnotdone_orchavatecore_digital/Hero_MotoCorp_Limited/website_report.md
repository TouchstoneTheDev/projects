# Accessibility & GTM Outreach Audit Report — Hero MotoCorp Limited
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Hero_MotoCorp_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Hero_MotoCorp_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Hero_MotoCorp_Limited_Homepage_Lighthouse_Summary.png`
