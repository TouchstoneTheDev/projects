# Accessibility & GTM Outreach Audit Report — Blue Star Limited
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Blue_Star_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Blue_Star_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Blue_Star_Limited_Homepage_Lighthouse_Summary.png`
