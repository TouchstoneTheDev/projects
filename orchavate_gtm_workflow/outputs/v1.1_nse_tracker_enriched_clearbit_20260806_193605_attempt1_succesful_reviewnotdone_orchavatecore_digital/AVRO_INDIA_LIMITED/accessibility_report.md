# Accessibility & GTM Outreach Audit Report — AVRO INDIA LIMITED

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `96 / 100`  
> **Total WCAG Violations:** `1`  
> **Verified Contact Email:** `info@avrotros.nl`  
...
- **Primary Outreach Contact:** `info@avrotros.nl` (`Verified`)
...
- **Company Name:** AVRO INDIA LIMITED
- **Resolved URL:** [https://avrotros.nl](https://avrotros.nl)
...
- **Primary Contact Email:** `info@avrotros.nl` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `info@avrotros.nl` | **Status:** `Verified` | **Source Page:** https://avrotros.nl
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/AVRO_INDIA_LIMITED_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/AVRO_INDIA_LIMITED_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/AVRO_INDIA_LIMITED_Homepage_Lighthouse_Summary.png`
