# Accessibility & GTM Outreach Audit Report — HCL Infosystems Limited
...
9. **`[other] nested-interactive`** (SERIOUS)
   ...
   - **Selector:** `#\38 54 > option[value="2025"]`
10. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `#\38 54 > option[value="2024"]`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/HCL_Infosystems_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/HCL_Infosystems_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/HCL_Infosystems_Limited_Homepage_Lighthouse_Summary.png`
