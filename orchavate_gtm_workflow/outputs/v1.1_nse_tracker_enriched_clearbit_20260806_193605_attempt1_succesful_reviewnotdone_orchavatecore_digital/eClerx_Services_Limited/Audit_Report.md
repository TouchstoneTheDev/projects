# Accessibility & GTM Outreach Audit Report — eClerx Services Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `info@eclerx.com`  
...
- **Primary Outreach Contact:** `info@eclerx.com` (`Verified`)
...
- **Company Name:** eClerx Services Limited
- **Resolved URL:** [https://eclerx.com](https://eclerx.com)
...
- **Primary Contact Email:** `info@eclerx.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `info@eclerx.com` | **Status:** `Verified` | **Source Page:** https://eclerx.com
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/eClerx_Services_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/eClerx_Services_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/eClerx_Services_Limited_Homepage_Lighthouse_Summary.png`
