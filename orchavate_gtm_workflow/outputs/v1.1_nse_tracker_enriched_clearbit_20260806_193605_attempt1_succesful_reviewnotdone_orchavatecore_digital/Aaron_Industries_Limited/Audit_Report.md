...
1. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `#content-089f0246a74957cca7ce-tab > .elementskit-tab-title`
...
5. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.elementor-widget-container > a[target="_blank"]`
...
7. **`[other] nested-interactive`** (SERIOUS)
   ...
   - **Selector:** `#sm-17860450721752878-1`
8. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `#sm-17860450721752878-3`
9. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `#sm-17860450721752878-5`
