# Accessibility & GTM Outreach Audit Report — Cineline India Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `office@cineline.pl`  
...
- **Primary Outreach Contact:** `office@cineline.pl` (`Verified`)
...
- **Resolved URL:** [https://cineline.pl](https://cineline.pl)
...
- **Primary Contact Email:** `office@cineline.pl` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `office@cineline.pl` | **Status:** `Verified` | **Source Page:** https://cineline.pl
...
2. **`[other] link-name`** (SERIOUS)
   ...
   - **Selector:** `.link-block-7`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Cineline_India_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Cineline_India_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Cineline_India_Limited_Homepage_Lighthouse_Summary.png`
