# Accessibility & GTM Outreach Audit Report — Gravita India Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `96 / 100`  
> **Total WCAG Violations:** `1`  
> **Verified Contact Email:** `hello@gravitate.ai`  
...
- **Primary Outreach Contact:** `hello@gravitate.ai` (`Verified`)
...
- **Resolved URL:** [https://gravitate.ai](https://gravitate.ai)
...
- **Primary Contact Email:** `hello@gravitate.ai` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `hello@gravitate.ai` | **Status:** `Verified` | **Source Page:** https://gravitate.ai
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Gravita_India_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Gravita_India_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Gravita_India_Limited_Homepage_Lighthouse_Summary.png`
