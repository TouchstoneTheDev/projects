# Accessibility & GTM Outreach Audit Report — Associated Alcohols & Breweries Ltd.

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `info@aabl.in`  
...
- **Primary Outreach Contact:** `info@aabl.in` (`Verified`)
...
- **Company Name:** Associated Alcohols & Breweries Ltd.
- **Resolved URL:** [https://associatedalcohols.com](https://associatedalcohols.com)
...
- **Primary Contact Email:** `info@aabl.in` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **Investor Grievance / Compliance Officer Email:** `investorrelations@aabl.in` | **Status:** `Verified` | **Source Page:** https://associatedalcohols.com/investor-contact/
- **General Contact Email:** `info@aabl.in` | **Status:** `Verified` | **Source Page:** https://associatedalcohols.com
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Associated_Alcohols___Breweries_Ltd__Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Associated_Alcohols___Breweries_Ltd__Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Associated_Alcohols___Breweries_Ltd__Homepage_Lighthouse_Summary.png`
