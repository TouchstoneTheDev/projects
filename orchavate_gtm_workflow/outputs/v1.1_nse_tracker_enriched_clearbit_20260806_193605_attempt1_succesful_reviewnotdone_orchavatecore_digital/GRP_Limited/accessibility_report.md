# Accessibility & GTM Outreach Audit Report — GRP Limited
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/GRP_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/GRP_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/GRP_Limited_Homepage_Lighthouse_Summary.png`
