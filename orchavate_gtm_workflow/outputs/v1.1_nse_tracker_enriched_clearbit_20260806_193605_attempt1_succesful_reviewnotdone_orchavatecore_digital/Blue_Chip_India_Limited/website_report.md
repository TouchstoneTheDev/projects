# Accessibility & GTM Outreach Audit Report — Blue Chip India Limited

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `bevsales@bluechipbev.com`  
...
- **Primary Outreach Contact:** `bevsales@bluechipbev.com` (`Verified`)
...
- **Company Name:** Blue Chip India Limited
- **Resolved URL:** [https://bluechipgroup.net](https://bluechipgroup.net)
...
- **Primary Contact Email:** `bevsales@bluechipbev.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `bevsales@bluechipbev.com` | **Status:** `Verified` | **Source Page:** https://bluechipgroup.net
...
1. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.button--primary-ghost`
2. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `#menu-item-133 > a`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Blue_Chip_India_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Blue_Chip_India_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Blue_Chip_India_Limited_Homepage_Lighthouse_Summary.png`
