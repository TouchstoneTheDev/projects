...
> **Verified Contact Email:** `info@abmk.in`  
...
- **Primary Outreach Contact:** `info@abmk.in` (`Unverified - guessed pattern`)
...
- **Resolved URL:** [https://www.abmk.in](https://www.abmk.in)
...
- **Primary Contact Email:** `info@abmk.in` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@abmk.in` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@abmk.in` | **Status:** `Unverified - guessed pattern`
