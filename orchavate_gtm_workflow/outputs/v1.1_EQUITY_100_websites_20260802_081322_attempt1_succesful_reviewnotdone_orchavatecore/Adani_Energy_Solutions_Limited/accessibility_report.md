...
> **Total WCAG Violations:** `83`  
> **Verified Contact Email:** `Prashant.Soni@adani.com`  
...
- **Primary Outreach Contact:** `Prashant.Soni@adani.com` (`Verified`)

### Executive Overview & Pitch Angle
This company currently scores **30/100** on automated WCAG 2.1 AA accessibility testing with **83 identified WCAG violations**. 
...
- **Impact Breakdown:** Critical: `17` | Serious: `66` | Moderate: `0`
...
- **Resolved URL:** [https://www.adanienergysolutions.com](https://www.adanienergysolutions.com)
...
- **Primary Contact Email:** `Prashant.Soni@adani.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **Investor Grievance / Compliance Officer Email:** `Prashant.Soni@adani.com` | **Status:** `Verified` | **Source Page:** https://www.adanienergysolutions.com/investors
- **General Contact Email:** `Prashant.Soni@adani.com` | **Status:** `Verified` | **Source Page:** https://www.adanienergysolutions.com/investors
