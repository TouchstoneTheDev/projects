...
> **Verified Contact Email:** `info@hyattregencymumbai.com`  
...
- **Primary Outreach Contact:** `info@hyattregencymumbai.com` (`Unverified - guessed pattern`)
...
- **Resolved URL:** [https://www.hyattregencymumbai.com](https://www.hyattregencymumbai.com)
...
- **Primary Contact Email:** `info@hyattregencymumbai.com` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@hyattregencymumbai.com` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@hyattregencymumbai.com` | **Status:** `Unverified - guessed pattern`
