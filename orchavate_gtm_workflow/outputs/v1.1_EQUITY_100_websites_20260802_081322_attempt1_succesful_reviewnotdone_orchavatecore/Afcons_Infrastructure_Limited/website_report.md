...
> **Verified Contact Email:** `info@afcons.com`  
...
- **Primary Outreach Contact:** `info@afcons.com` (`Unverified - guessed pattern`)
...
- **Resolved URL:** [https://www.afcons.com](https://www.afcons.com)
...
- **Primary Contact Email:** `info@afcons.com` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@afcons.com` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@afcons.com` | **Status:** `Unverified - guessed pattern`
