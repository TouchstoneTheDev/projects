# Accessibility & GTM Outreach Audit Report — Lancor Holdings Ltd

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `lancor@lancor.es`  
...
- **Primary Outreach Contact:** `lancor@lancor.es` (`Verified`)
...
- **Company Name:** Lancor Holdings Ltd
- **Resolved URL:** [https://lancor.es](https://lancor.es)
...
- **Primary Contact Email:** `lancor@lancor.es` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `lancor@lancor.es` | **Status:** `Verified` | **Source Page:** https://lancor.es
...
1. **`[other] link-name`** (SERIOUS)
   ...
   - **Selector:** `.elementor-element-ce9062b > .elementor-widget-container > a`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Lancor_Holdings_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Lancor_Holdings_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Lancor_Holdings_Ltd_Homepage_Lighthouse_Summary.png`
