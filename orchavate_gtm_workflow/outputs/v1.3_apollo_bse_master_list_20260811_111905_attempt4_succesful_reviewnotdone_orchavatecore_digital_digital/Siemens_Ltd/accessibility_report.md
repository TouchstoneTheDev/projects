...
- **Impact Breakdown:** Critical: `6` | Serious: `8` | Moderate: `0`
...
2. **`[other] aria-required-parent`** (CRITICAL)
   ...
   - **Selector:** `#nav-4tbDrKz7olW9W7M5z9J2Bn`
3. **`[other] aria-required-parent`** (CRITICAL)
   - **Help:** Certain ARIA roles must be contained by particular parents
   - **Selector:** `#nav-1gtxhyM7ea1wJrVr3RNsrF`
4. **`[other] aria-required-parent`** (CRITICAL)
   - **Help:** Certain ARIA roles must be contained by particular parents
   - **Selector:** `#nav-1CKjmK641z39tIloE9pTyD`
5. **`[other] aria-required-parent`** (CRITICAL)
   - **Help:** Certain ARIA roles must be contained by particular parents
   - **Selector:** `#nav-3EdlrZZudkjB1ZQRGnOrIj`
6. **`[other] aria-required-parent`** (CRITICAL)
   - **Help:** Certain ARIA roles must be contained by particular parents
   - **Selector:** `#nav-63ZbAiKOYIuLUJO5Z6CtD2`
