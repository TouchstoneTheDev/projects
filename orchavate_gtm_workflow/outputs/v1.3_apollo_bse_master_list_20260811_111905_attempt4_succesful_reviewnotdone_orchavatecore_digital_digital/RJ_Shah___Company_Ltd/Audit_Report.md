...
- **Impact Breakdown:** Critical: `6` | Serious: `11` | Moderate: `0`
...
7. **`[other] button-name`** (CRITICAL)
   ...
   - **Selector:** `button[data-ux="SlideshowArrowsButtonPrevious"]`
8. **`[other] button-name`** (CRITICAL)
   - **Help:** Buttons must have discernible text
   - **Selector:** `button[data-ux="SlideshowArrowsButtonNext"]`
