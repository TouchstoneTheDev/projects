# Accessibility & GTM Outreach Audit Report — Bhagyanagar India Ltd
...
- **Impact Breakdown:** Critical: `2` | Serious: `23` | Moderate: `0`
...
1. **`[other] aria-command-name`** (SERIOUS)
   ...
   - **Selector:** `iframe[data-last-width="1920"] > .pzNkMb-euCgFf-LgbsSe`
2. **`[other] aria-prohibited-attr`** (SERIOUS)
   - **Help:** Elements must only use permitted ARIA attributes
   - **Selector:** `iframe[data-last-width="1920"] > .i4ewOd-pzNkMb-xl07Ob-haAclf`
3. **`[other] aria-prohibited-attr`** (SERIOUS)
   - **Help:** Elements must only use permitted ARIA attributes
   - **Selector:** `iframe[data-last-width="1920"] > .i4ewOd-pzNkMb-n9oEIb`
4. **`[other] aria-prohibited-attr`** (SERIOUS)
   - **Help:** Elements must only use permitted ARIA attributes
   - **Selector:** `iframe[data-last-width="1920"] > .nJjxad-bEDTcc-LgbsSe`
5. **`[other] aria-prohibited-attr`** (SERIOUS)
   - **Help:** Elements must only use permitted ARIA attributes
   - **Selector:** `iframe[data-last-width="1920"] > .nJjxad-m9bMae-LgbsSe`
...
9. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#content-3cfec486a7a3af8656dd-tab > .elementskit-tab-title`
10. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#content-3cfec486a7a3af8656dd > .animated.fadeIn > .elementor-3185[data-elementor-id="3185"][data-elementor-type="section"] > .elementor-element-3927953.e-parent[data-id="3927953"] > .elementor-element-551e14f.e-con-boxed[data-id="551e14f"] > .e-con-inner > .elementor-element-9332db9.elementor-widget-button[data-id="9332db9"] > .elementor-button-link.elementor-size-sm.elementor-button > .elementor-button-content-wrapper > .elementor-button-text`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Bhagyanagar_India_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Bhagyanagar_India_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Bhagyanagar_India_Ltd_Homepage_Lighthouse_Summary.png`
