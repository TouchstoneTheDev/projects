...
1. **`[other] aria-allowed-attr`** (CRITICAL)
   ...
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-fty-c60=""]:nth-child(1) > a[_ngcontent-fty-c60=""]`
2. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-fty-c60=""]:nth-child(2) > a[_ngcontent-fty-c60=""]`
3. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-fty-c60=""]:nth-child(3) > a[_ngcontent-fty-c60=""]`
4. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `.accordion-navigation.wpfs[_ngcontent-fty-c60=""]:nth-child(4) > a[_ngcontent-fty-c60=""]`
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `dt:nth-child(2)`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.info[_ngcontent-fty-c71=""] > strong`
