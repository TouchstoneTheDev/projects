...
- **Impact Breakdown:** Critical: `4` | Serious: `29` | Moderate: `0`
...
5. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `#\32 92133 > .limit-width.row-parent[data-imgready="true"] > .wpb_row.row-inner > .col-lg-3.column_parent.wpb_column > .uncol.style-light > .uncoltable > .no-block-padding.uncell.boomapps_vccolumn > .uncont > .uncode_text_column > p`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#\37 32227 > .limit-width.row-parent[data-imgready="true"] > .wpb_row.row-inner > .col-lg-3.column_parent.wpb_column > .uncol.style-light > .uncoltable > .no-block-padding.uncell.boomapps_vccolumn > .uncont > .uncode_text_column > p`
7. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.single-media-link[href$="tyre-and-tubes/"]`
8. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.single-media-link[href$="automotive/"]`
9. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.single-media-link[href$="truck-and-bus-wheel/"]`
10. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.single-media-link[href="/automotive-airconditioning/"]`
