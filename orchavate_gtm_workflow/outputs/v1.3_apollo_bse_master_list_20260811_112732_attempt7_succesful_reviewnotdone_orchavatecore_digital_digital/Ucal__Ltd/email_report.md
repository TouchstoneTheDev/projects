...
> **Verified Contact Email:** `hyrs@ucalgary.ca`  
...
- **Primary Outreach Contact:** `hyrs@ucalgary.ca` (`Verified`)
...
- **Primary Contact Email:** `hyrs@ucalgary.ca` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `hyrs@ucalgary.ca` | **Status:** `Verified` | **Source Page:** https://ucalgary.ca/#
