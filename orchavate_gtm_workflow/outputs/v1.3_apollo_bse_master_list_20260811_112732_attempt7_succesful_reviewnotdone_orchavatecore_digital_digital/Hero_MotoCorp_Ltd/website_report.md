...
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.slick-slide[data-slick-index="5"][aria-hidden="true"] > div > .connect-card-col-3.connect-card-container > .connect-card-1.connect-card-wrapper > .text-container > .primary-cta[data-analyticsposition="STAY CONNECTED"][target="_blank"]`
