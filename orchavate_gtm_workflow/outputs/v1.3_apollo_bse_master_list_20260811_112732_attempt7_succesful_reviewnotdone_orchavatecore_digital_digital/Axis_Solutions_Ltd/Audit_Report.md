# Accessibility & GTM Outreach Audit Report — Axis Solutions Ltd
...
- **Company Name:** Axis Solutions Ltd
...
2. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#banner-home-privy-cmp-AE1VSVI8T5 > .powered-privy-cmp-AE1VSVI8T5 > .powered-privy-cmp-AE1VSVI8T5-text`
3. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `#banner-home-privy-cmp-AE1VSVI8T5 > .powered-privy-cmp-AE1VSVI8T5 > span > a[href$="privybyidfy.com/"][target="_blank"]`
4. **`[other] meta-viewport`** (MODERATE)
   - **Help:** Zooming and scaling must not be disabled
   - **Selector:** `meta[name="viewport"]`
5. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `.SumoSelect`
6. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `option[value="Eng"]`
7. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `option[value="हिंदी"]`
8. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `li[aria-controls="bannerSavingsAc"]`
9. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `li[aria-controls="bannerCreditCards"]`
10. **`[other] nested-interactive`** (SERIOUS)
   - **Help:** Interactive controls must not be nested
   - **Selector:** `li[aria-controls="bannerLoans"]`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Axis_Solutions_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Axis_Solutions_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Axis_Solutions_Ltd_Homepage_Lighthouse_Summary.png`
