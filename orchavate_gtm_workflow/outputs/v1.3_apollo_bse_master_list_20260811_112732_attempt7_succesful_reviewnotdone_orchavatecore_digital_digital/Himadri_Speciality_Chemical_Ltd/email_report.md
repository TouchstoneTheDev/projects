...
1. **`[other] aria-allowed-attr`** (CRITICAL)
   ...
   - **Selector:** `.testimonial__area-2 > iframe > .ytmVideoInfoVideoTitle`
2. **`[other] aria-prohibited-attr`** (SERIOUS)
   - **Help:** Elements must only use permitted ARIA attributes
   - **Selector:** `.testimonial__area-2 > iframe > #movie_player`
3. **`[other] button-name`** (CRITICAL)
   - **Help:** Buttons must have discernible text
   - **Selector:** `.testimonial__area-2 > iframe > .ytmVideoInfoChannelAvatar`
