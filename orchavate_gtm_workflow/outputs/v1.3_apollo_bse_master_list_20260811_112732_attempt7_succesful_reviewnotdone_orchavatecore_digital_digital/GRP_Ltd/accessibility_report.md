# Accessibility & GTM Outreach Audit Report — GRP Ltd

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `investor@grp.com.sg`  
...
- **Primary Outreach Contact:** `investor@grp.com.sg` (`Verified`)
...
- **Company Name:** GRP Ltd
- **Resolved URL:** [https://grp.com.sg](https://grp.com.sg)
...
- **Primary Contact Email:** `investor@grp.com.sg` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `investor@grp.com.sg` | **Status:** `Verified` | **Source Page:** https://grp.com.sg/contact-us/
...
1. **`[other] link-name`** (SERIOUS)
   ...
   - **Selector:** `.logo > a[href$="grp.com.sg/"]`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/GRP_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/GRP_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/GRP_Ltd_Homepage_Lighthouse_Summary.png`
