# Accessibility & GTM Outreach Audit Report — EL CID Investments Ltd
...
- **Company Name:** EL CID Investments Ltd
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/EL_CID_Investments_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/EL_CID_Investments_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/EL_CID_Investments_Ltd_Homepage_Lighthouse_Summary.png`
