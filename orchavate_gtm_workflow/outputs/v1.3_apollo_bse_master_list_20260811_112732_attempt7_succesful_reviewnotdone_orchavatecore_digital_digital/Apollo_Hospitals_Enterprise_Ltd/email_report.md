# Accessibility & GTM Outreach Audit Report — Apollo Hospitals Enterprise Ltd

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `30 / 100`  
> **Total WCAG Violations:** `95`  
> **Verified Contact Email:** `info@apollohospitals.com`  
...
- **Primary Outreach Contact:** `info@apollohospitals.com` (`Unverified - guessed pattern`)
...
- **Resolved URL:** [https://apollohospitals.com](https://apollohospitals.com)
...
- **Primary Contact Email:** `info@apollohospitals.com` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@apollohospitals.com` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@apollohospitals.com` | **Status:** `Unverified - guessed pattern`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Apollo_Hospitals_Enterprise_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Apollo_Hospitals_Enterprise_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Apollo_Hospitals_Enterprise_Ltd_Homepage_Lighthouse_Summary.png`
