# Accessibility & GTM Outreach Audit Report — RSWM Ltd

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `92 / 100`  
> **Total WCAG Violations:** `2`  
> **Verified Contact Email:** `info.rswm@Injbhilwara.com`  
...
- **Primary Outreach Contact:** `info.rswm@Injbhilwara.com` (`Verified`)
...
- **Company Name:** RSWM Ltd
- **Resolved URL:** [https://rswm.in](https://rswm.in)
...
- **Primary Contact Email:** `info.rswm@Injbhilwara.com` (`Verified`)
- **Overall Discovery Status:** `Verified`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email:** `info.rswm@Injbhilwara.com` | **Status:** `Verified` | **Source Page:** https://rswm.in
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/RSWM_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/RSWM_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/RSWM_Ltd_Homepage_Lighthouse_Summary.png`
