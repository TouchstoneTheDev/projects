# Accessibility & GTM Outreach Audit Report — Can Fin Homes Ltd

> **Audit Status:** `Completed`  
> **Lighthouse Accessibility Score:** `30 / 100`  
> **Total WCAG Violations:** `80`  
...
This company currently scores **30/100** on automated WCAG 2.1 AA accessibility testing with **80 identified WCAG violations**. 
...
- **Impact Breakdown:** Critical: `20` | Serious: `59` | Moderate: `1`
...
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Can_Fin_Homes_Ltd_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Can_Fin_Homes_Ltd_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Can_Fin_Homes_Ltd_Homepage_Lighthouse_Summary.png`
