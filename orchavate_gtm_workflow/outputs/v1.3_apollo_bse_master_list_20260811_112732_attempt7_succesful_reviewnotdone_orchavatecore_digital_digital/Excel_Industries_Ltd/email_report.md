...
- **Impact Breakdown:** Critical: `7` | Serious: `21` | Moderate: `0`
...
1. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.booking__property.jsx-932662252 > .theme-color-corp-booking-accent.jsx-932662252`
2. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.booking__dates > .theme-color-corp-booking-accent.jsx-932662252`
3. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.booking__rooms.jsx-932662252 > .theme-color-corp-booking-accent.jsx-932662252`
4. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.booking__promo.jsx-932662252 > .theme-color-corp-booking-accent.jsx-932662252`
5. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.button`
6. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.booking__additional-cta2-wrapper > .theme-color-corp-booking-accent.cta[target="_blank"]`
7. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.booking__additional-cta1 > .theme-color-corp-booking-accent.cta[target="_blank"]`
8. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `h3`
9. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `.newsletter-signup__copy > .jsx-3300793820:nth-child(2)`
