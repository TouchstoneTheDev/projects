...
This company currently scores **30/100** on automated WCAG 2.1 AA accessibility testing with **132 identified WCAG violations**. 
...
- **Impact Breakdown:** Critical: `60` | Serious: `72` | Moderate: `0`
...
10. **`[other] aria-allowed-attr`** (CRITICAL)
   - **Help:** Elements must only use supported ARIA attributes
   - **Selector:** `li:nth-child(11) > iframe[allowfullscreen=""] > .ytmVideoInfoVideoTitle`
