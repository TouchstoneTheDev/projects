...
This company currently scores **30/100** on automated WCAG 2.1 AA accessibility testing with **168 identified WCAG violations**. 
...
- **Impact Breakdown:** Critical: `105` | Serious: `63` | Moderate: `0`

### Technical Violation Breakdown
- 🖼️ **Missing Alt Text:** 97 violations
- 🎨 **Color Contrast Failures:** 54 violations
...
- **Color Contrast Ratios (54 issues):** Ensure text contrast against background meets minimum 4.5:1 ratio for normal text and 3:1 for large text.
