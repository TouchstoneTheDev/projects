# Accessibility & GTM Outreach Audit Report — Hindalco Industries Limited
...
- **Impact Breakdown:** Critical: `34` | Serious: `33` | Moderate: `0`
...
- **Resolved URL:** [https://www.hindalco.com](https://www.hindalco.com)
...
- **Investor Grievance / Compliance Officer Email:** `hilinvestors@adityabirla.com` | **Status:** `Verified` | **Source Page:** https://www.hindalco.com
- **General Contact Email:** `hilinvestors@adityabirla.com` | **Status:** `Verified` | **Source Page:** https://www.hindalco.com
...
9. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#truste-custom-footer-cookie-link-label-button`
10. **`[color_contrast] color-contrast`** (SERIOUS)
   - **Help:** Elements must meet minimum color contrast ratio thresholds
   - **Selector:** `#truste-privacy-button`

---

## 4. Evidence & Tool Screenshots
- 🎨 **WAVE WebAIM Overlay:** `screenshots/Hindalco_Industries_Limited_Homepage_WAVE_Overlay.png`
- 🛡️ **Axe DevTools Panel:** `screenshots/Hindalco_Industries_Limited_Homepage_Axe_DevTools.png`
- ⚡ **Lighthouse Summary:** `screenshots/Hindalco_Industries_Limited_Homepage_Lighthouse_Summary.png`
