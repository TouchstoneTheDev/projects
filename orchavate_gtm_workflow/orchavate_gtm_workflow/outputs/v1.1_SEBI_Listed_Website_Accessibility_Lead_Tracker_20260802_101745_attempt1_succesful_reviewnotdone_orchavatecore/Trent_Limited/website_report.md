...
- **Impact Breakdown:** Critical: `2` | Serious: `7` | Moderate: `0`
...
3. **`[color_contrast] color-contrast`** (SERIOUS)
   ...
   - **Selector:** `.text-\[\#FF0A0A\].font-semibold.md\:text-\[22px\]`
4. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `.lg\:w-auto > .md\:w-auto.md\:justify-start.active`
5. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `#header-logo-wrapper > .md\:w-auto.md\:justify-start.active`
6. **`[other] link-name`** (SERIOUS)
   - **Help:** Links must have discernible text
   - **Selector:** `#actual-header-logo > .md\:w-auto.md\:justify-start.active`
