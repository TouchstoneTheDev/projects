      ...
      <div style="padding: 12px 10px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 6px; text-align: center; margin-bottom: 12px;">
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #e53e3e; font-size: 14px; font-weight: bold;">✖ ${d.totalErrors}</span><br/>
            <span style="font-size: 9px; color: #718096;">Errors</span>
          </div>
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #c53030; font-size: 14px; font-weight: bold;">👁 ${d.totalContrast}</span><br/>
            <span style="font-size: 9px; color: #718096;">Contrast Errors</span>
          </div>
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #dd6b20; font-size: 14px; font-weight: bold;">⚠️ ${Math.floor(d.totalErrors * 1.5)}</span><br/>
            <span style="font-size: 9px; color: #718096;">Alerts</span>
          </div>
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #38a169; font-size: 14px; font-weight: bold;">🟢 ${Math.max(12, 180 - d.totalErrors * 2)}</span><br/>
            <span style="font-size: 9px; color: #718096;">Features</span>
          </div>
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #3182ce; font-size: 14px; font-weight: bold;">🏗 ${Math.max(8, 120 - d.totalErrors)}</span><br/>
            <span style="font-size: 9px; color: #718096;">Structure</span>
          </div>
          <div style="border: 1px solid #e2e8f0; padding: 6px 2px; border-radius: 4px; background: #ffffff;">
            <span style="color: #805ad5; font-size: 14px; font-weight: bold;">🏷 ${Math.max(15, 340 - d.totalErrors * 3)}</span><br/>
        ...
        <div style="background: #fff5f5; border: 1px solid #feb2b2; padding: 8px; border-radius: 6px; margin-bottom: 12px;">
          <span style="font-size: 10px; font-weight: bold; color: ${d.totalErrors > 20 ? '#c53030' : '#2f855a'};">AIM Score: ${d.aimScoreStr}</span>
          <div style="width: 100%; height: 6px; background: #edf2f7; border-radius: 3px; margin-top: 4px; overflow: hidden;">
            <div style="width: ${d.aimBarWidth}%; height: 100%; background: ${d.totalErrors > 20 ? '#e53e3e' : '#38a169'};"></div>
          </div>
        </div>
        ...
        <div style="font-size: 11px; color: #2d3748; padding-left: 4px; margin-bottom: 8px;">
          ☑ ${d.totalLabels} Missing form labels & aria
        </div>
